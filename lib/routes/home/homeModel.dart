...
class HomeModel extends _$HomeModel {
  ...
  void calculateAge() async {
    ...
    final countryCodes = ref
        .read(selectedCountriesModelProvider.select((m) => m.selection))
        .codes
        .toList();
    try {
      final ageData = await _ageRepository.getAgeInCountries(
          name: name!, countries: countryCodes);
